...
train_image_path = r'C:\Users\coanh\Desktop\UNI\AIC\Classification Competetion\cifar-10\train'
...
if __name__ == '__main__':
    ...
    testSet = CIFARDataset(yml_labels=yml_label, image_dir=train_image_path, csv_dir=csv_path)
